...
import { Trash2, Edit2, Plus, Search, CheckCircle, RefreshCw } from 'lucide-react';
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="flex flex-col gap-1">
                          <span className={`px-2 py-1 rounded-full text-xs font-bold w-fit ${
                            ...
                            restaurant.subscriptionPlan === 'Basic' ? 'bg-blue-100 text-blue-700' :
                            'bg-gray-100 text-gray-700'
                          }`}>
                            {restaurant.subscriptionPlan}
                          </span>
                          <span className="text-[10px] text-gray-500">
                            Exp: {restaurant.subscriptionExpires ? new Date(restaurant.subscriptionExpires).toLocaleDateString() : '-'}
                          </span>
                        </div>
                      </td>
